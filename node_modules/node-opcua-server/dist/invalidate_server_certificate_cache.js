...
exports.invalidateServerCertificateCache = invalidateServerCertificateCache;
/**
 ...
 * ```
 */
function invalidateServerCertificateCache(server) {
    (0, node_opcua_common_1.invalidateCachedSecrets)(server);
    for (const ep of server.endpoints) {
        ep.invalidateCertificates();
    }
}
//# sourceMappingURL=invalidate_server_certificate_cache.js.map