...
export declare function getValidatorFuncForType(dataType: DataType): (value: unknown) => boolean;
export declare function getRandomFuncForType(dataType: DataType): () => unknown;
